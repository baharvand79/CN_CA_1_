...
//public:
//    explicit WebRTC(QObject *parent = nullptr, QString id = "id");

//    Q_INVOKABLE void init();
//    // Q_INVOKABLE void addPeer();
//    Q_INVOKABLE void connectToSignalingServer();

//    Q_INVOKABLE void handleSDP(const QString &sdp, const QString &type);
//    Q_INVOKABLE void createOffer();
//    Q_INVOKABLE void sendToServer(const QJsonObject &message);
